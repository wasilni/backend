...
use App\Notifications\StarTriNotification;
...
if($user->lang=='en'){
       $title ='Trip Started' ;
        ...
        $title = 'الرحلة بدأت  الان ';
        $body = 'الرحلة بدأت تجاه الموقع';
}
        ...
        $title_ar = 'الر😊حلة بدأت  الان ';
        $body_ar = 'الرحلة بدأت تجاه الموقع  ';
        
        
        
          
        
       $user->notify(new StarTriNotification($title_ar,$title_en, $body_ar,$body_en));
