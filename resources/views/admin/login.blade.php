...
<head>
    ...
    <link rel="shortcut icon" href="{{ fav_icon() ?? asset('images/email/logoneew.png') }}">
    ...
    <style>
        ...
        body {
            background-image: url(assets/images/bgew.jpeg) !important;
            ...
            <div class="col-lg-4 col-md-8 col-12">
                <div class="login-box">
                    <div class="login-box-body text-center">
                        ...
                        <img src="{{ fav_icon() ?? asset('images/favicon.png') }}" alt="" style=" height: 111px;">
                        <h3 class="text-center" style="text-align: center!important;
    color: #40b840;
    font-weight: bold; font-family: 'Almarai';">مدير نظام لوحة القيادة</h3>
                        ...
                        <form class="login_form" id="form" enctype="multipart/form-data">
                            <div class="col-12 form-group has-feedback"
                                ...
                                <div class="col-md-11 mx-auto p-0 login-email">
                                    <input type="email" style="border-radius:none;" class="form-control rounded"
                                        name="email" id="emailaddress" required="" placeholder="البريد الالكترونى" maxlength="74"
                           ...
                           <span class="ion ion-locked form-control-feedback"></span>
                                ...
                                <div class="col-md-11 mx-auto text-center p-0 login-email"  style="text-align: inherit;">
                                    <input type="password" name="password" style="border-radius:none;" required=""
                                        id="password" class="form-control rounded" placeholder="كلمة السر " maxlength="30"
                                        data-validation="required length" data-validation-length="8-30"
                                        data-validation-error-msg-length="Password should have atleast 8 characters."   style="text-align: inherit;">
                                </div>
                            ...
                            <div class="col-md-11 mx-auto text-center p-0">
                                ...
                                <div class="col-12 text-center login-btn">
                                    <button class="btn btn-info btn-block margin-top-10 submit_button"
                                        type="submit" style="background-color: #40b840;"> الدخول</button>
                                </div>
                                <!-- /.col -->
                            </div>
                        </form>
