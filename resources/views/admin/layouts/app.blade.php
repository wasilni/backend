<!DOCTYPE html>
<html lang="{{ config('app.locale') }}" @if(App::getLocale() == 'en') style="direction: ltr" @else style="direction: rtl" @endif>
...
<body class="hold-transition skin-blue sidebar-mini fixed @if(App::getLocale() == 'ar') rtl @endif">
    <!-- Begin page -->
