     ...
     <a href="#" class="logo">
         ...
         <b class="logo-mini">
             <span class="light-logo" style="display: flex;align-items: end;">
                 <img
                     src="{{ app_logo() ?? asset('images/email/logoneew.png') }}" style="width: 77px;
    padding-right: 5px;
    height: 63px;
                     alt="logo">
                     <!--{{ app_name() ?? 'wasilni' }}--></span>
             <span class="dark-logo" style="display: flex;align-items: end;"><img
                     src="{{ app_logo() ?? asset('images/email/logoneew.png') }}" style="
                     width: 77px;
    padding-right: 5px;
    height: 63px;
   "
                             ...
                             <div class="row no-gutters">
                                 <div class="col-12 text-left">
                                     <a href="{{ url('admins/profile', auth()->user()->id) }}"><i
                                             class="ion ion-person"></i>@lang('view_pages.My_Profile')
</a>
                                 </div>
                                 <div role="separator" class="divider col-12"></div>
                                 <div class="col-12 text-left">
                                     <a href="{{ url('api/spa/logout') }}" class="logout"><i
                                             class="fa fa-power-off"></i>@lang('view_pages.Logout') </a>
                                 </div>
                             </div>
                             <!-- /.row -->
                         </li>
