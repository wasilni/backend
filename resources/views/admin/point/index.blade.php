...
<div class="row">
    ...
    <thead>
        <tr>
            ...
            <th> @lang('pages_names.price')</th>
            <th> @lang('view_pages.typeuses')</th>
                        <th> @lang('view_pages.typeusesapp')</th>
...
<tbody>
    ...
    @forelse($results as $key => $result)
        <tr>
            ...
            <td>{{$result->price }}</td>
                        <td>@if($result->typeuses=='driver')
                        
                        {{trans('view_pages.driver')}}
                        @else
                      {{  trans('view_pages.user')}}
                        @endif</td>
   <td>@if($result->typeusesapp == "charge")
                        
                        {{trans('view_pages.charge')}}
                        @else
                      {{  trans('view_pages.trip')}}
                        @endif</td>
            ...
            <button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('view_pages.action')
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{url('admins/point/update',$result->id)}}"><i class="fa fa-pencil"></i>@lang('view_pages.edit')</a>
