    ...
    @else
    <link rel="stylesheet" href=" https://cdnjs.cloudflare.com/ajax/libs/bootstrap-v4-rtl/4.1.1-1/css/bootstrap-rtl.min.css">
    ...
    @else
    <link rel="stylesheet" href="{!! asset('assets/css/master_rtl_style.css') !!}">
	<link rel="stylesheet" href="{!! asset('assets/css/skins/rtl.css') !!}">
