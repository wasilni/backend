                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="driver[]" id="driver" class="form-control select2"  multiple="multiple"
                             >
                                                {{-- <option value="" selected disabled>@lang('view_pages.select')</option> --}}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="title">@lang('view_pages.push_title_en') <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" id="title" name="title_en"
                                                value="{{ old('title') }}" required
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.push_title_en')">
...
<div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="title">@lang('view_pages.push_title_ar') <span class="text-danger">*</span></label>
                                            <input class="form-control" type="text" id="title" name="title_ar"
                                                value="{{ old('title') }}" required
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.push_title_ar')">
                                            <span class="text-danger">{{ $errors->first('title') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="message">@lang('view_pages.message_en') <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="message_en" id="message" rows="3" placeholder="@lang('view_pages.enter') @lang('view_pages.message_en')" required>{{ old('message') }}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="message">@lang('view_pages.message_ar') <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="message_ar" id="message" rows="3" placeholder="@lang('view_pages.enter') @lang('view_pages.message_ar')" required>{{ old('message') }}</textarea>
                                            <span class="text-danger">{{ $errors->first('message') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-primary btn-sm" type="button" onclick="$('#image').click()" id="upload">
                                    @lang('view_pages.browse')</button>
                                            <button class="btn btn-danger btn-sm" type="button" id="remove_img" style="display: none;">
                                                @lang('view_pages.remove')
                                            </button><br>
