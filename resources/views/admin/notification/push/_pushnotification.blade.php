<table class="table table-hover">
    <thead>
        <tr>    
            ...
            <th> @lang('view_pages.push_title_en')</th>
            <th> @lang('view_pages.push_title_ar')</th>

            <th> @lang('view_pages.message_en')</th>
             <th> @lang('view_pages.message_ar')</th>
...
<tbody>
    ...
    @forelse($results as $key => $result)
        <tr>
            ...
            <td>{{ $result->body_en }}</td>
            <td>{{ $result->body_ar }}</td>
            <td>
