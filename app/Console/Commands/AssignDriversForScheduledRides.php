...
class AssignDriversForScheduledRides extends Command
{
    ...
    public function handle()
    {
       ...
       $title ='New Trip Requested' ;
        ...
        $title = 'طلب رحلة جديد ';
        $body = 'طلب رحلة جديد عليك قبول ام رفض';
          $message = 'تم طلب رحلة جديد عليك قبول ام رفض   ';
       }
       
       
       $notifable_driver->notify(new AndroidPushNotification($title, $body));
                        
         $title_ar ='New Trip Requested' ;
        $body_ar = 'New Trip Requested, you can accept or Reject the request';
        $title_en = 'طلب رحلة جديد ';
        $body_en = 'تم طلب رحلة جديد عليك قبول أو رفض   ';
