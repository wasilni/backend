    ...
    Route::group(['prefix' => 'drivers'], function () {
       ...
       Route::get('fetch/negative-balance-drivers', 'DriverController@NegativeBalanceFetch');
        ...
        Route::group(['prefix' => 'admins',  'middleware' => 'permission:admin'], function () {
            ...
            Route::get('Pointsbalance','PointController@index');
            Route::get('point/create', 'PointController@create');
            Route::post('point/store', 'PointController@store');
            Route::post('point/update/{point}', 'PointController@update');
            Route::get('point/update/{point}', 'PointController@edit');

            Route::get('point/delete/{point}', 'PointController@destroy');
            
            
                        Route::get('Levels','LevelController@index');
                        Route::get('level/update/{level}', 'LevelController@edit');
                         Route::post('level/update/{level}', 'LevelController@update');
