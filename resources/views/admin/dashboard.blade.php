    ...
    <section class="content">
                ...
                <div class="card overflow-hidden" style="min-width: 12rem">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="display-4 fs-4 mb-2 font-weight-normal font-sans-serif text-warning"
                            ...
                            href="{{url('/drivers/waiting-for-approval')}}">
                                {{ trans('pages_names.See_all') }}
                                <span class="fa fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-3">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="font-weight-600">{{ trans('pages_names.Today_Trips') }} </h3>
                                <ul class="box-controls pull-right">
                                    <li><a class="box-btn-close" href="#"></a></li>
                                    <li><a class="box-btn-slide" href="#"></a></li>
                                    <li><a class="box-btn-fullscreen" href="#"></a></li>
            ...
            <div class="col-12 col-lg-12">
                ...
                <div class="box">
                    <div class="box-header with-border pb-0 mb-20">
                        ...
                        <h3 class="font-weight-600">
                             {{ trans('pages_names.Overall_Earnings')}} </h3>
                        <ul class="box-controls pull-right">
                            <li><a class="box-btn-close" href="#"></a></li>
                            <li><a class="box-btn-slide" href="#"></a></li>
                            <li><a class="box-btn-fullscreen" href="#"></a></li>
                                    ...
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content" style="color: #455a80">
                                            <h4 class="font-weight-600">
                                                ...
                                                <br>
                                    {{ trans('pages_names.Overall_Earnings')}}
                                            </h4>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-12 col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="font-weight-600"> {{ trans('pages_names.Cancellation_Chart')}}</h3>
                        <ul class="box-controls pull-right">
                            <li><a class="box-btn-close" href="#"></a></li>
                            <li><a class="box-btn-slide" href="#"></a></li>
                            <li><a class="box-btn-fullscreen" href="#"></a></li>
                                ...
                                {{ trans('pages_names.Total_Request_Cancelled')}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-body bg-primary" style="background-color: #1e88e5 !important">
                                            ...
                                            <div class="text-right">
                            {{ trans('pages_names.Cancelled_due_to_no_Drivers')}}
                                                </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="box box-body bg-primary" style="background-color: #26c6da !important">
                                            ...
                                            <div class="text-right">
                                {{ trans('pages_names.Cancelled_by_User')}}
                                                 </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <script>
        $(document).ready(function() {
            ...
            if ($('#trips').length > 0) {
                ...
                var data7 = {
                    labels: [
                        "{{trans('pages_names.Completed')}}",
                      "{{trans('pages_names.Cancelled')}}",
                      "{{trans('pages_names.Scheduled')}}"
