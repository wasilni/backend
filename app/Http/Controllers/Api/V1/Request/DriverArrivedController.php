...
use App\Notifications\DriveArriveNotification;
...
class DriverArrivedController extends BaseController
{
    ...
    */
    ...
    if($user->lang=='en'){
       ...
       $body = 'Driver arrived to pickup you';
        ...
        $title_ar = 'السائق وصل  😊️';
        $body_en = 'Driver arrived to pickup you';
        $body_ar = 'السائق وصل ';
        
        
       $user->notify(new DriveArriveNotification($title_ar,$title_en, $body_ar,$body_en));
