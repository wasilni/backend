...
use App\Notifications\DriverAcceptRequestNotification;
...
class RequestAcceptRejectController extends BaseController
{
    ...
    */
    ...
    $title_en ='Trip Request Accepted 😊';
        $title_ar = ' طلب الرحلة مقبول  😊️';
        $body_en = 'The Driver is coming to pickup you';
