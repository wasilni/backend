...
class RatingsController extends BaseController
{
    ...
    */
    public function rateRequest(TripRatingRequest $request)
    {
        ...
        $request_rating_params = ['user_id'=>$user_id,'driver_id'=>$driver_id,'request_id'=>$request->request_id,
        'rating'=>$request->rating,
        'comment'=>$request->comment,
        'user_rating'=>$user_rating,
        'driver_rating'=>$driver_rating,
        
        'not_statisfied_ar'=>$request->not_statisfied_ar,
        'not_statisfied_en'=>$request->not_statisfied_en,
