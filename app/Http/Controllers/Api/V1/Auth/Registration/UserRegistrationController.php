...
class UserRegistrationController extends LoginController
{
    ...
    * @bodyParam company_key string optional company key of demo
    ...
    public function register(UserRegistrationRequest $request)
    {
        ...
        // DB::beginTransaction();
        // try {    
        $Setting= Setting::where('name','register_point')->first();
...
if($reffered_user->lang=='en'){
 ...
 $reffered_user->notify(new ReferrelcodeNotification($title_ar,$title_en, $body_ar,$body_en));
