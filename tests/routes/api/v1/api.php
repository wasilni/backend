...
Route::post('transferepoints', 'PointController@transferepoints');
Route::post('transferepointstofriend', 'PointController@transferepointstofriend');
    Route::get('allnotification', 'PointController@allnotification');
...
Route::namespace('Common')->group(function () {
    ...
    Route::get('servicelocation', 'ServiceLocationController@index');
            Route::get('setLocale/{lang}', 'TranslationController@store');
