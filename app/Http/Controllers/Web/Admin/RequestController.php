...
class RequestController extends Controller
{
    ...
    public function getSingleRequest(RequestRequest $request)
    {
      ...
      $RequestRatingsuser=  RequestRating::where('request_id',$request->id)
      ...
      ->where('driver_rating',1)->get();
        ...
        return view('admin.request.requestview', compact('page', 'main_menu', 'sub_menu', 'item','RequestRatingsuser','RequestRatingsdriver'));
