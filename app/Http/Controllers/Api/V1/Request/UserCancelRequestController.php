...
if($driver->user->lang=='en'){
       ...
       $title ='الرحلة التغت من الزبون' ;
        $body = 'الزبون لغى الرحلة  ';
}
     ...
     $title_en ='Trip Cancelled By Customer 🙁' ;
     $body_en = 'The customer cancelled the ride,please wait for another ride';
     $title_ar ='الرحلة التغت من الزبون' ;
     $body_ar = 'الزبون لغى الرحلة  ';
        
 $notifiable_driver->notify(new CustomerCancelRequestNotification($title_ar,$title_en, $body_ar,$body_en));
