      ...
      <li class="treeview  active menu-open">
        <a href="javascript: void(0);">
         <i class="fa fa-podcast"></i> 
          <span> @lang('pages_names.points') </span>
          <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
          </span>
        </a>
        ...
        <ul class="treeview-menu">
          <li class="{{ 'user_report' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('admins/Pointsbalance')}}"><i class="fa fa-circle-thin"></i> @lang('pages_names.pointreplacebudget') </a>
          </li>
        </ul>
      </li>
        ...
        <a href="javascript: void(0);">
         <i class="fa fa-level-up"></i> 
          <span> @lang('pages_names.Levels') </span>
          <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
          </span>
        </a>
        ...
        <ul class="treeview-menu">
          <li class="{{ 'user_report' == $sub_menu ? 'active' : '' }}">
            <a href="{{url('admins/Levels')}}"><i class="fa fa-circle-thin"></i> @lang('pages_names.Levelsdriver') </a>
          </li>
        </ul>
      </li>
